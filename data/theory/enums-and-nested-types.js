...
const enumsAndNestedTypesModule = {
    ...
    chapters: [
...

        {
            ...
            importance: 'must-know',
            summary: 'One keyword between them, and it decides whether every instance carries a hidden reference to an enclosing object. Default to static.',
            ...
            blocks: [
                ...
                },
                {
                    ...
                    rows: [
                        ...
                        ['<code>class</code> (inner)', '<code>this$0</code>', 'Genuinely needs the enclosing instance — an iterator over its owner\'s state'],
